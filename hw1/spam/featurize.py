...
def generate_design_matrix(filenames):
    ...
    for w in long_word:
        long_freq[w] += 1
    sorted_freq = sorted(long_freq.items(), key=operator.itemgetter(1))
    sorted_freq.reverse()
    #print(sorted_freq[30:40])
